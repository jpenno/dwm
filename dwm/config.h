...
static const char *fonts[] = {"fira code:size=22"};
...
static const char col_gray6[] = "#8be9fd";
...
static Key keys[] = {
    ...
    /* { 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("pamixer
       --allow-boost -i 1; kill -44 $(pidof dwmblocks)") }, */
    /* { 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("pamixer
       --allow-boost -d 1; kill -44 $(pidof dwmblocks)") }, */
